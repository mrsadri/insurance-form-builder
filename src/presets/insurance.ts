...
export function preset_medliability(): FormSchema {
  return _form('medical-liability', [
    ...
    _stp('تعهدات و پوشش‌ها', [_sec('تعهدات', [
      _it('select', 'تعداد دیه (سقف تعهد)', { id: 'diya_count', hint: 'کوثر برای پزشکان فقط یک دیه صادر می‌کند؛ سینا تا چهار دیه می‌پذیرد', items: _opt(['یک دیه','دو دیه','سه دیه','چهار دیه']) }),
      _it('radio', 'نرخ دیه ماه حرام', { id: 'haram_rate', hint: 'دو یا سه نرخ فقط در بیمه ایران قابل ارائه است', items: _opt(['یک نرخ (استاندارد)','دو نرخ','سه نرخ']) }),
      _it('select', 'افزایش ریالی سرمایه (مازاد بر تعهد)', { id: 'capital_increase', required: false, hint: 'پوشش تورم دیه، ویژه بیمه ایران', items: _opt(['بدون پوشش','تا ۵۰٪','تا ۷۰٪','تا ۱۰۰٪']) }),
...
export const OFFERS: Record<string, OfferOption[]> = {
  ...
  'medical-liability': [
    ...
    { insurer: 'ایران', note: '۱۰٪ تخفیف نقدی و تخفیف عدم خسارت تا ۶۰٪؛ پوشش‌های اختیاری: جنگ، زیبایی، مسئول فنی داروخانه، دیه ماه حرام، افزایش سرمایه' },
